...
public class GlobalControllerErrorHandler {
	 ...
	 * @ExceptionHandler(UnsupportedOperationException.class)
	 * 
	 * @ResponseStatus(code = HttpStatus.INTERNAL_SERVER_ERROR) public
	 * ExceptionMessage handleException(Exception ex, WebRequest webRequest) {
	 * 
	 ...
	 * 
	 * @ResponseStatus(code = HttpStatus.NOT_FOUND) public ExceptionMessage
	 * handleNoSuchElementException(Exception ex, WebRequest webRequest) { return
